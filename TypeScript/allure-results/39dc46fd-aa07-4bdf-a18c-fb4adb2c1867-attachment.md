...
- Name: browsercommands.test.ts >> Login DemoBlaze
- Location: PlayWright\tests\browsercommands.test.ts:3:1
...
```ts
  ...
  11 | 
  12 |     // 1.title
> 13 |     await expect(page.title()).toEqual("STORE")
     |                                ^ Error: expect(received).toEqual(expected) // deep equality
  14 | 
  15 |     // 2.Current url
  16 |     console.log(page.url())
  17 | 
  18 |     
  19 | 
  20 | 
