...
> 30 |     await page.fill("#loginpasswor","admin")
     |                ^ Error: page.fill: Test timeout of 30000ms exceeded.
  31 | 
  32 |     await page.click("//*[@id='logInModal']/div/div/div[3]/button[2]")
  33 | 
  34 |     //soft assertion
  35 |     await expect.soft(page.locator("//a[@id='logout2']").textContent(),"Log Out")
  36 |     await expect.soft(page.locator("//a[@id='logout2']")).toBeVisible()
  37 | 
