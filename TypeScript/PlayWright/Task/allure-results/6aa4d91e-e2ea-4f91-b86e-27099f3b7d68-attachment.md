...
- Name: checkbox.test.ts >> Checkbox demo
- Location: tests\checkbox.test.ts:3:5
                          ...
                          - generic [ref=f2e1256]:
                            ...
                            - generic [ref=f2e1325]:
                              ...
                              - generic [ref=f2e1329]:
                                ...
                                - strong [ref=f2e1343]: "7"
                                - strong [ref=f2e1346]: "8"
                                - strong [ref=f2e1349]: "4"
                                - strong [ref=f2e1352]: "9"
                          - table:
                            - rowgroup:
                              - row:
                                - cell
...
```ts
  ...
  2  | 
  3  | test("Checkbox demo",async({page})=>{
  4  |     await page.goto("https://omayo.blogspot.com/")
  5  | 
  6  |     await page.click("//button[normalize-space()='Check this']")
  7  | 
  8  |     await page.check("//input[@id='dte']")
  9  | 
> 10 |     await expect(page.isChecked("//input[@id='dte']")).toBe(true)
     |                                                        ^ Error: expect(received).toBe(expected) // Object.is equality
  11 |     
  12 | })
```