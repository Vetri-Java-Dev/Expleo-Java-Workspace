...
```
Error: page.click: Unexpected token "/" while parsing css selector "/html/body/div[3]/div/div/div[3]/button[2]". Did you mean to CSS.escape it?
Call log:
  - waiting for /html/body/div[3]/div/div/div[3]/button[2]
