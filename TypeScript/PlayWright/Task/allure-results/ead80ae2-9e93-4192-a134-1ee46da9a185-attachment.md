...
- Name: filemanipulation.test.ts >> File Upload test
- Location: tests\filemanipulation.test.ts:3:5
...
Expected: "1_Control_Flow_Statements (1).pdf"
Received: Promise {}
```
                          ...
                          - generic [ref=f2e1256]:
                            ...
                            - generic [ref=f2e1325]:
                              ...
                              - generic [ref=f2e1329]:
                                ...
                                - strong [ref=f2e1349]: "2"
                                - strong [ref=f2e1352]: "2"
                          - table:
                            - rowgroup:
                              - row:
                                - cell
...
```ts
  ...
  8  | 
> 9  |     await expect(page.locator("//input[@id='uploadfile']").inputValue()).toBe("1_Control_Flow_Statements (1).pdf")
     |                                                                          ^ Error: expect(received).toBe(expected) // Object.is equality
  10 | 
  11 | })
```